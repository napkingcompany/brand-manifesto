...
- **v1.3.0** — Dataset metadata synchronized across README, CFF, CodeMeta, GitHub, GitLab, Zenodo, Hugging Face, OSF, and Harvard Dataverse.
...
- **v1.0.0** — Initial public brand corpus release.
